...
class BotConfig(BaseSettings):
    ...
    campaign_filter_max_slots_per_day: int = Field(default=0, alias="CAMPAIGN_FILTER_MAX_SLOTS_PER_DAY")
    auto_lock_enabled: bool = Field(default=False, alias="AUTO_LOCK_ENABLED")
    auto_lock_max_concurrent: int = Field(default=5, alias="AUTO_LOCK_MAX_CONCURRENT")
